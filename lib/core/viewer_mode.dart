...
///
/// True on iOS and Windows, where the CLI cannot run: tmux is not optional to it. On macOS and Linux
/// only with `--dart-define=HARNESS_VIEWER_MODE=true`, which is how the path is developed and
/// tested on a Mac against real machines.
