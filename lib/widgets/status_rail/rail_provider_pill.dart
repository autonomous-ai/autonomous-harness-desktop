...
///
/// Not "No provider", which is what the picker inside this menu calls the same
/// state. A menu row is a CHOICE and is fairly named for what it is not; a
/// readout is a STATEMENT and has to say what is true. What is true with no
/// provider chosen is that the agents bill the Claude and Codex subscriptions
/// this machine is signed into — which is also exactly what the figures to the
/// right of this pill are counting, so the two halves of the strip finally
/// describe one thing.
///
