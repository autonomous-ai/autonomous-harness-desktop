...
class TerminalLinkOpener {
  ...
  Future<String?> open(String target, {required bool isLocalMachine}) async {
    ...
    try {
      ...
      if (parsed.scheme == 'https' || parsed.scheme == 'http') {
        ...
        if (!isLocalMachine) {
          return 'This file is on another machine. Open a web link or download it to this computer first.';
        }
        var path = target;
